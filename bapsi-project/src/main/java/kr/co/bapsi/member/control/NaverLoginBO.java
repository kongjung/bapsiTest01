...
public class NaverLoginBO {
	...
	private final static String CLIENT_ID = "02_uu7iUlNilJCX0LMK5"; // 네이버API Client ID
	private final static String CLIENT_SECRET = "mdZxnRVjhX";
	private final static String REDIRECT_URI = "http://localhost:8000/bapsi/login/callback.do";
